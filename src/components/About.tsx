            ...
            <div className="relative group">
              ...
              <div className="relative">
                <img
                  src={profileImage}
                  alt="Pavan Lambole"
                  className="w-72 h-72 md:w-96 md:h-96 object-cover rounded-full border-4 border-white dark:border-gray-800 shadow-2xl"
                />
              </div>
            </div>
          </motion.div>
          ...
          >
            ...
            <div className="flex flex-wrap gap-4 pt-4">
              <motion.button
                ...
                whileTap={{ scale: 0.95 }}
                className="px-6 py-3 bg-gradient-to-r from-blue-600 to-cyan-600 text-white rounded-lg font-medium flex items-center gap-2 hover:shadow-lg transition-all duration-300"
              >
                <Download size={20} />
                Download CV
              </motion.button>
              ...
              <motion.button
                ...
                whileHover={{ scale: 1.05 }}
                whileTap={{ scale: 0.95 }}
                className="px-6 py-3 border-2 border-blue-600 dark:border-cyan-400 text-blue-600 dark:text-cyan-400 rounded-lg font-medium hover:bg-blue-600 hover:text-white dark:hover:bg-cyan-400 dark:hover:text-gray-900 transition-all duration-300"
              >
                Contact Me
              </motion.button>
            </div>
